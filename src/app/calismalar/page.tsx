...
const trustMetrics = [
  { end: 2.4, prefix: "$", suffix: "B+", decimals: 1, label: "Yönetilen Varlık Hacmi", color: "text-emerald-accent" },
  { end: 300, prefix: "%", suffix: "", decimals: 0, label: "Ortalama ROI (İlk Yıl)", color: "text-indigo-accent" },
  { end: 500, prefix: "", suffix: "+", decimals: 0, label: "Kurumsal Dağıtım", color: "text-gray-400" },
];
        ...
        <main className="flex-grow pt-20">
          <section className="py-section-padding px-margin-mobile md:px-margin-desktop max-w-[1280px] mx-auto text-center">
            <div className="max-w-3xl mx-auto space-y-8">
              <span className="animate-on-scroll font-body text-xs font-bold tracking-wide text-emerald-accent uppercase block">
                Başarı Hikayeleri
              </span>
              <h1 className="animate-on-scroll stagger-1 font-display text-[56px] font-bold leading-[64px] tracking-[-0.02em] text-white max-[768px]:text-[32px] max-[768px]:leading-[40px]">
                Müşterilerimizin Sonuçları
              </h1>
              <p className="animate-on-scroll stagger-2 font-body text-lg leading-[28px] text-gray-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="animate-on-scroll md:col-span-8 bg-[#162040] border border-white/5 rounded-2xl overflow-hidden group hover:border-white/15 transition-colors duration-300">
                ...
                <div className="p-8 space-y-6">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <span className="font-body text-xs font-bold tracking-wide text-indigo-accent">
                      Küresel Perakende
                    </span>
                    <span className="font-body text-xs font-bold tracking-wide text-gray-500 border border-white/10 px-2 py-1 rounded-full">
                      Tedarik Zinciri
                    </span>
                  </div>
                  <h2 className="font-display text-[28px] font-semibold leading-[36px] text-white">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                    <div>
                      ...
                      <div className="font-body text-xs font-bold tracking-wide text-gray-500">
                        Maliyet Azalması
                      </div>
                      <div className="mt-2">
                    ...
                    <div>
                      <div className="font-display text-4xl text-emerald-accent">
              ...
              <div className="animate-on-scroll stagger-1 md:col-span-4 bg-[#162040] border border-white/5 rounded-2xl p-8 flex flex-col justify-between hover:border-emerald-accent/30 transition-colors duration-300">
                <div className="space-y-4">
                  <span className="font-body text-xs font-bold tracking-wide text-emerald-accent">
                    FinTech
                  </span>
                  <h3 className="font-display text-[32px] font-semibold leading-[40px] text-white">
              ...
              <div className="animate-on-scroll stagger-3 md:col-span-8 bg-[#0A1020] border border-white/5 rounded-2xl p-8 relative overflow-hidden group hover:border-white/15 transition-colors duration-300">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center h-full">
                  <div className="flex-1 space-y-4">
                    <span className="font-body text-xs font-bold tracking-wide text-gray-500 border border-white/10 px-2 py-1 rounded-full inline-block">
                      Endüstriyel Üretim
                    </span>
                    <h2 className="font-display text-[28px] font-semibold leading-[36px] text-white">
                  ...
                  <div className="w-full md:w-1/3 bg-[#162040] rounded-xl p-6 border border-white/5">
                    <div className="text-center space-y-2">
                      ...
                      <div className="font-display text-5xl text-emerald-accent">
                      ...
                      <div className="w-full bg-white/5 h-2 rounded-full mt-4 overflow-hidden">
                        <div className="bg-emerald-accent h-full w-[42%] rounded-full" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section className="py-section-padding bg-[#060A14] border-t border-white/5">
            <div className="max-w-[1280px] mx-auto px-margin-mobile md:px-margin-desktop text-center space-y-16">
              <div className="max-w-2xl mx-auto space-y-4">
                <h2 className="animate-on-scroll font-display text-5xl font-semibold leading-[56px] text-white max-[768px]:text-[32px]">
                  Rakamlar Kendini Konuşuyor
                </h2>
                <p className="animate-on-scroll stagger-1 font-body text-lg leading-[28px] text-gray-400">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {trustMetrics.map((m, i) => (
                  ...
                  >
                    <div className="font-display text-[64px] font-bold leading-[72px] tracking-[-0.02em] text-white max-[768px]:text-5xl">
                      <AnimatedCounter
                        end={m.end}
                        prefix={m.prefix}
                        suffix={m.suffix}
